...
class MemoryEveningLifecycleTest extends TestCase
{
    ...
    public function test_gallery_memory_becomes_shared_calendar_ritual_album_and_reflection(): void
    {
        ...
        $this->assertNotEmpty($completed['album']['uuid']);
        $this->assertNotEmpty($completed['shared_memory']['uuid']);
    ...
    {
        [$owner, $partner, $space] = $this->couple();
        $media = $this->media($space, $owner, 'moment.jpg', now()->subYear());
        ...
        $this->assertDatabaseCount('memory_evenings', 1);
