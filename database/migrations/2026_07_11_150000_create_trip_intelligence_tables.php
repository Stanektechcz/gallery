...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('trip_budget_limits')) {
        ...
        if (! Schema::hasTable('trip_location_shares')) {
        ...
        } elseif (! Schema::hasIndex('trip_location_shares', 'trip_loc_share_owner_unique')) {
            Schema::table('trip_location_shares', function (Blueprint $table) {
                $table->unique(['trip_id', 'owner_user_id', 'recipient_user_id'], 'trip_loc_share_owner_unique');
            });
        }

        if (! Schema::hasTable('trip_track_points')) {
