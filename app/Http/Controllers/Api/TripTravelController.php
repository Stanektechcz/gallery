...
class TripTravelController extends Controller
{
    ...
    public function storeTransport(Request $request, int $tripId): JsonResponse
    {
        ...
        return response()->json($this->choice($tripId, $request->user()->id, 'transport', $data, $variantId, null, $expenseId, $selected), 201);
    }

    public function storeAccommodation(Request $request, int $tripId): JsonResponse
    {
        $trip = $this->trip($request, $tripId);
        ...
        return response()->json($this->choice($tripId, $request->user()->id, 'accommodation', $data, null, $activityId, $expenseId, $selected), 201);
    }
