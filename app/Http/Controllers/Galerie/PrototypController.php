...
JS,
            ...
            /*
             * Fronta zápisů se tu už nepřepisuje.
             *
             * Náhrada dosazovala do **každého** zápisu ve frontě token toho,
             * kdo byl zrovna přihlášený — a co napsal jeden bez signálu, po
             * odhlášení odešlo pod druhým. Fronta teď rozlišuje autora zápisu
             * a slučuje zápisy téže adresy; to je víc než pár řádků k náhradě,
             * takže to stojí přímo v `sw.js` (dokumenty se dnes upravují přímo).
             */
