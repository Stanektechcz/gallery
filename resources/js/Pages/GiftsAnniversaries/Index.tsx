...
import GiftBudgetPanel from '@/Components/GiftBudgetPanel';
...
export default function GiftsAnniversariesIndex() {
    ...
    return <AppLayout><Head title="Dárky a výročí"/><main className="w-full p-4 sm:p-6">
        ...
        {spaceId && <div className="mt-5 space-y-5"><RelationshipAnniversarySettings spaceId={spaceId} showRecap={false}/><GiftBudgetPanel spaceId={spaceId}/><GiftAutomation spaceId={spaceId}/></div>}
    </main></AppLayout>;
}
