                ...
                return (
                    <Link key={item.id} href={`/media/${item.uuid}`}>
                        <div className="w-16 h-16 rounded-lg overflow-hidden bg-[var(--color-bg-card)] shrink-0">
                            {thumb
                                ? <img src={thumb} alt="" loading="lazy" decoding="async" fetchPriority="low" className="w-full h-full object-cover hover:scale-105 transition-transform duration-200" />
