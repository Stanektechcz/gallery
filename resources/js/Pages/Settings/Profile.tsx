                ...
                {profile && (
                    <>
                        ...
                        <p className="mt-5 text-center text-xs text-[var(--color-text-secondary)]">
                            <Link href="/settings/propojeni" className="panel-link text-[var(--color-accent)] hover:underline">Úložiště a služby</Link>
                            {' · '}
                            <Link href="/settings/vzhled" className="panel-link text-[var(--color-accent)] hover:underline">Vzhled a barvy</Link>
                        </p>
                    </>
                )}
            </main>
